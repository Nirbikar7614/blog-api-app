...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto){
        ...
        Role roles = roleRepository.findByRoleName("ROLE_ADMIN").get();//get the roll object
        user.setRoles(Collections.singleton(roles));//it will convert roleobject to a set
